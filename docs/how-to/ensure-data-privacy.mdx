...
Align data handling practices with international data protection standards and frameworks, such as the General Data Protection Regulation [GDPR](https://gdpr-info.eu/) and the [NIST Privacy Framework](https://www.nist.gov/privacy-framework).
